...
for i in range(0, len(inputlist)):
    ...
    total += ((int(numbers[0])*int(numbers[1])*int(numbers[2])) + (2*((int(numbers[0])+int(numbers[1])+int(numbers[2])) - (max(int(numbers[0]),int(numbers[1]),int(numbers[2]) )))))
    print(total)
